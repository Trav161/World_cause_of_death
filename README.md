...
Full Project with Visualizations:
...
# - Working with large amounts of Dat
...
Finding the global average number of deaths and comparing it to what is occurring in a particular country. By doing this, we are not only able to see which countries are fairing better but also where countries may be struggling, and the need for policy change.
